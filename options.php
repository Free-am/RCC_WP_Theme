...
<form method="post">
	<input name="themeUrl" size="40" value="<?php echo get_option('themeUrl'); ?>" placeholder="renchuanchuan.com" />
...
function addOptionsPage(){   
    add_theme_page( 'RCC Options', 'RCC Options', 'administrator', 'RCCThemeOptions','OptionsFunc');   
}
